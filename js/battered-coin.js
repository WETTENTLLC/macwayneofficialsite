...
class BatteredCoinApp {
    ...
    async handlePurchase(formData) {
        ...
        try {
            ...
            this.showPurchaseSuccess(coinsPurchased, amount);
     ...
     */
    showPurchaseSuccess(coins, amount) {
        const notification = this.createNotification(
            'success',
            'Purchase Successful!',
            `You have successfully purchased ${coins} MWB coins for $${amount}. Coins will be transferred to your wallet within 10 minutes.`
        );
