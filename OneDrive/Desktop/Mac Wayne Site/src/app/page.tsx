        ...
        <section className="strange-section w-full py-10 max-w-full" style={{ margin: 0, border: 'none', background: 'transparent', boxShadow: 'none', padding: 0 }}>
          <div style={{ padding: '2rem', textAlign: 'center' }}>
            ...
            <div className="flex justify-center gap-4 flex-wrap w-full">
              ...
              <Link href="#video-section" className="strange-button">WATCH VIDEOS</Link>
            </div>
          </div>
        </section>

        {/* Featured Video Section */}
        <section id="video-section" className="strange-section w-full my-8 flex flex-col items-center">
          <h2 className="strange-header mb-8">WATCH NOW</h2>
          <div className="video-container w-full max-w-4xl mx-auto">
            <div className="relative pb-[56.25%] h-0 overflow-hidden rounded-lg shadow-xl">
              <iframe 
                ...
                src="https://www.youtube.com/embed/CkDPQkDTxC8"
                title="Mac Wayne - Blind & Battered"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
                allowFullScreen
              ></iframe>
            </div>            <p className="text-center text-gray-300 mt-4">
              &ldquo;Blind &amp; Battered&rdquo; - The official music video from Mac Wayne
            </p>
            <div className="flex justify-center mt-6">
              <Link href="/documentary" className="strange-button">
