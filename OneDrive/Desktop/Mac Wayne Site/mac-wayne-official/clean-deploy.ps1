...
Write-Host "7. Force pushing to GitHub (This will overwrite remote repository)..." -ForegroundColor Red
$confirmForce = Read-Host "Are you sure you want to force push? This will overwrite remote repository. (y/n)"
...
Write-Host "5. Select branch 'main' and folder '/ (root)'" -ForegroundColor White
