    ...
    <div className="strange-theme min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center w-full">
        ...
        <section className="strange-section w-full my-8 flex flex-col items-center">
          <div className="relative w-full max-w-3xl mx-auto flex flex-col md:flex-row items-center bg-black/70 rounded-xl shadow-lg overflow-hidden transition-all duration-700">
